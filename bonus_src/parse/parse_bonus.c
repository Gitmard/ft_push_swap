...
/*   Updated: 2026/02/16 13:33:06 by vquetier         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */

#include "parse_defines_bonus.h"

static int	parse_flags(char *arg, t_stacks *stacks)
{
...
static int	parse_current(char *arg, t_stacks *stacks, t_set *set)
{
...
static int	check_flags(t_stacks *stacks)
{
	uint32_t	strategies;
